...
const layout: IDC.DatacenterLayout = {
  ...
  pxPerMeter: 40,
  cabinets: [
    { cabinetId: 'cab-b-04', x: -4.2, y: -1.2, rotation: 176 },
    { cabinetId: 'cab-b-05', x: -1.6, y: -1.35, rotation: 180 },
    { cabinetId: 'cab-c-01', x: 1.55, y: -1.55, rotation: 182 },
    { cabinetId: 'cab-c-02', x: 4.05, y: -1.45, rotation: 183 },
    { cabinetId: 'cab-a-03', x: -3.2, y: 1.3, rotation: 180 },
    { cabinetId: 'cab-a-04', x: -0.8, y: 1.25, rotation: 180 },
    { cabinetId: 'cab-a-05', x: 1.7, y: 1.12, rotation: 180 },
    { cabinetId: 'cab-b-01', x: 4.2, y: 1.05, rotation: 180 },
    { cabinetId: 'cab-a-01', x: -5.45, y: 3.55, rotation: 178 },
    { cabinetId: 'cab-a-02', x: -2.8, y: 3.45, rotation: 180 },
    { cabinetId: 'cab-b-02', x: 0.1, y: 3.4, rotation: 180 },
    { cabinetId: 'cab-b-03', x: 3.1, y: 3.35, rotation: 182 },
  ],
  zones: [
    {
      id: 'cold-aisle-1',
